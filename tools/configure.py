...
def exec_get_stdout(cmd, input=None, default=None, print_stdout=False):
    try:
        ...
        if print_stdout:
            sys.stdout.write(ret[0].decode('utf8'))
            sys.stdout.flush()
        if proc.returncode != 0:
            sys.stdout.write(ret[1].decode('utf8'))  # print stderr on error
            sys.stdout.flush()
